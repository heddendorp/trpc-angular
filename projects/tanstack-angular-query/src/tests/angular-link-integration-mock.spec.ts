...
function mockAngularHttpLink(opts: { url: string; httpClient: HttpClient; headers?: any }) {
  ...
  describe('Factory Pattern with HttpClient Integration', () => {
    ...
    it('should work with complex factory patterns and custom headers', () => {
      ...
      class UserProfileComponent {
        ...
        userQuery = injectQuery(() => this.trpc.greet.queryOptions({ name: 'Test User' }));
        updateUserMutation = injectMutation(() => this.trpc.createUser.mutationOptions());
  ...
  describe('Integration Pattern Examples', () => {
    it('should demonstrate the complete integration pattern from documentation', () => {
      ...
      class UserProfileComponent {
        ...
        userQuery = injectQuery(() => this.trpc.greet.queryOptions({ name: 'User' }));
      }
